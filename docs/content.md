...
- 主标题：光影帧格
- 副标题：一个收藏个人摄影作品与心爱电影的视觉空间
- 图片素材：`/public/images/Content/fr*`
- 介绍正文：
...
- Hero 图片下方展示的四个信息：
  - 平台：Web 网站
  - 网址链接：[点击前往](https://frame-space.vercel.app/gallery)
...
- 主标题：The Wild Oasis
- 副标题：一个预订多洛米蒂山脉特色豪华木屋的在线平台（教学项目）
- 图片素材：`../public/images/Content/wild_*`
- 介绍正文：
...
- Hero 图片下方展示的四个信息：
  - 平台：Web 网站
  - 网址链接：[https://the-wild-oasis-web-phi.vercel.app](https://the-wild-oasis-web-phi.vercel.app)
  - 技术栈：Next.js 14、React、TypeScript、Tailwind CSS、Supabase、NextAuth
  - 开发时间：2025

# Omnifood

- 主标题：Omnifood
- 副标题：一个提供个性化营养方案的健康餐订阅网站（教学项目）
- 图片素材: `../public/images/Content/omni_*`
- 介绍正文：
...
- Hero 图片下方展示的四个信息：
  - 平台：Web 网站
  - 网址链接：[https://onifood-soulkk.netlify.app/](https://onifood-soulkk.netlify.app/)
...
- 主标题：kk抢场
- 副标题：一个面向杭电学生的羽毛球场地自动抢场预约系统
- 图片素材：`../public/images/Content/script_*`
- 介绍正文：
  帮助我和我的球友实现了场地自由的项目！用户可以填写预约日期、个人信息和多个备选时间段，并按照个人偏好调整 12 个场地的预约优先级。任务创建后，系统会同步预约服务器时间，在晚上 8 点开放预约时自动发起抢场请求，并实时展示倒计时、请求状态、执行日志和最终结果；运行中的任务也支持手动取消。
...
- Hero 图片下方展示的四个信息：
  - 平台：Web 网站
  - 网址链接：[点击前往](https://badminton.soul-kk.top/)
