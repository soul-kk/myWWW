...
export const badmintonProject: LifeProjectDetail = {
  ...
  description: [
    ...
    "羽毛球是我的第一个爱好，也一直是我生活中不可或缺的一部分。练球给了我充沛的体能基础，比赛锻炼我的心理素质，平时的娱乐对抗很好的帮我缓解了其他事情带给我的压力，让我专注于球场，享受当下。我发现羽毛球的很多思想其实可以延伸到诸多领域，富含哲理，比如：击球讲究瞬间发力而不是蛮力挥拍，这叫张弛有度；打球要带着目的组织球路而不是盲目乱打，体现目标与规划的重要性；而不同人的不同球风也能体现这个人的性格或思想，很有意思。",
